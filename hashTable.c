...
void arquivo(char* nome_arq)
{
    ...
    // Aloca a mem�ria para a struct data
...
/**
    Fun��o que insere elementos do arquivo

    Sistema de colis�o: Linear Probing
**/
...
/**  Fun��o que imprime os dados da struct **/
